// Mainframe macro generated from application: ./SS
// By ROOT version 6.28/04 on 2024-08-20 12:24:45
...
void Style_BELLE2()
{
   ...
   Int_t tmpPaletteColor[255] = { 924, 925, 926, 927, 928, 929, 930, 931, 932,
   ...
   tmpStyle->SetPalette(255, tmpPaletteColor);

   TString tmpLineStyleArray[30] = { "", "  ", "  12 12 ", " 4 8",
   ...
   for (Int_t i=0; i<30; i++)
      tmpStyle->SetLineStyleString(i, tmpLineStyleArray[i]);
